...
const HotelCard = ({room, index}) => {
  return (
   <Link to={'/rooms/' + room._id} onClick={()=> scrollTo(0,0)} key={room._id}className='relative max-w-70 w-full rounded-xl overflow-hidden bg-white text-gray-500/90 shadow-[0px_4px_4px_rgba(0,0,0,0,0.05 )]'>
    ...
    <div  className='p-4 pt-5'>
        <div className=''>
            ...
            <div className='flex items-center gap-1'>
                <img src={assets.starIconFilled} className='' alt="star-icon" /> 4.5
            </div>
